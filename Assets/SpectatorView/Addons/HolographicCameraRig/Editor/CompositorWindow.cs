...
public class CompositorWindow : EditorWindow
{
    ...
    void OnEnable()
    {
        ...
        {
            SpectatorView.HolographicCameraManager.Instance.frameProviderInitialized = false;
            SetFrameOffset(SpectatorView.HolographicCameraManager.Instance.DefaultFrameOffset);
            SetAlpha(SpectatorView.HolographicCameraManager.Instance.DefaultAlpha);
        }
    }
    ...
    void OnDestroy()
    {
        if (SpectatorView.HolographicCameraManager.Instance != null)
        {
            SpectatorView.HolographicCameraManager.Instance.ResetCompositor();
        }
    }
